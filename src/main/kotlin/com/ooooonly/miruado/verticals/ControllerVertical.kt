...
class ControllerVertical:CoroutineVerticle() {
...
//            handler(SessionHandler.create(LocalSessionStore.create(vertx)))
    ...
    private fun apiBot(router:Router) {
        ...
        router.apply {
            ...
            postCoroutineHandlerApply(ROOT, this@ControllerVertical) {
            ...
            deleteCoroutineHandlerApply("/:botId", this@ControllerVertical) {
    ...
    private fun apiScript(router:Router) {
        ...
        router.apply {
            ...
            getCoroutineHandlerApply("/:index/reload", this@ControllerVertical) {
    ...
    private fun apiFile(router: Router){
        router.apply {
            getCoroutineHandlerApply("/:filename/raw", this@ControllerVertical) {
            ...
            putCoroutineHandlerApply("/:filename/raw", this@ControllerVertical) {
                val file = File(Config.Upload.SCRIPTS, pathParam("filename"))
                withContext(Dispatchers.IO) {
            ...
            putCoroutineHandlerApply("/:filename/name", this@ControllerVertical) {
                val file = File(Config.Upload.SCRIPTS, pathParam("filename"))
            ...
            getCoroutineHandlerApply("/:filename/file", this@ControllerVertical) {
                val file = File(Config.Upload.SCRIPTS, pathParam("filename"))
                if (!file.exists()) return@getCoroutineHandlerApply responseNotFoundEnd("不存在此文件！")
